...
\added[id=TC]{A robot that repeatedly causes damage may be disqualified from a
given a specific match or the whole tournament at the referee's discretion.}
