...
Award Criteria and Rubrics {rules-year}  
...
|Corrected 3 bonus points for mention in TDP form                                 | 2025-06-18 +
|Update 2026/Added rules and point system regarding the short video form TDP      | 2026-04-10 +
|===
...
*2.*	*Technical Documentation Paper Form* (TDP Form) (Maximum of 7 Points) +
...
*7.*	*Short form video TDP* (Maximum of 1 Point) +
...
This explanation is broken down into two parts, first a short explanation in this section and then a more thorough explanation in the next part of this document.
...
Technical Description Paper. You will receive this form via official communication after signing up for the international competitions. Note there are two bonus points mentioned within the TDP form.
...
You will receive official communication about how and when to submit this poster.
...
RoboCupJunior puts a lot of emphasis on innovation, and this section is specifically designed to give teams the opportunity to show the feature they are most proud of in a nutshell. 
What we want you to do is to create a video shorter than 3 minutes about this feature. 
This section is scored based on if you managed to explain clearly what this feature is, and why you find it the most interesting.

.Short Form Video TDP Scoring Values
|===
...
be met:
*	Elements of the TDP Form, Short Form Video TDP, Group Interview, and Poster exceeded expectations
...
*	The TDP Form, Short Form Video TDP, Group Interview, and Poster clearly describe an innovation that is potentially effective and instructive.
...
*	The TDP Form, Short Form Video TDP, Group Interview, and Poster is comprehensive, well-organised and clearly explains the team’s engineering decisions and iterations.
...
TDP documents and published. There are 2 bonus points available through the TDP Form, *1 bonus point* for Open-Sourcing the CAD files, PCB and Schematic files, and *1 bonus point* for Open-Sourcing Software repositories.
...
Technical difficulties or facing a very tough opponent during the international competition can be reasons for a lot of teams to not be able to demonstrate all the amazing capabilities their robots can do. 
For this reason we have added this section for teams to truly be able to demonstrate the feature they are most proud of.

|===
| *Rubrics*     | Developing | Satisfactory
| Short Form Video TDP | The explanation is not easy to follow and other teams cannot figure out what has gone into this feature inside the robot. | The video is easy to follow and a fellow competitor can understand how this feature has been done and why it can be impactful in the robot. +
|===
