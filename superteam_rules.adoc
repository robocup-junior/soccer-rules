= RoboCupJunior Soccer SuperTeam Rules 2027
{docdate}
:toc: left
:sectanchors:
:sectlinks:
...
These are the SuperTeam Soccer rules for RoboCupJunior 2027. They are
...
[discrete]
=== Changes from the 2026 RoboCupJunior Soccer SuperTeam Rules
...
[[general-rules]]
== RoboCupJunior International 2027 General Rules
