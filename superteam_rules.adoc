...
TIP: This ruleset is available at https://github.com/robocup-junior/soccer-rules/
including a full history of changes made. During the rules development process
new changes are also collected there as pull requests. Feedback and contributions
are welcome there as well as on the forum (https://junior.forum.robocup.org/).
