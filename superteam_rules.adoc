= RoboCupJunior Soccer SuperTeam Rules {rules-year}
{docdate}
:toc: left
:sectanchors:
:sectlinks:
...
These are the SuperTeam Soccer rules for RoboCupJunior {rules-year}. They are
...
[discrete]
=== Changes from the {previous-rules-year} RoboCupJunior Soccer SuperTeam Rules
...
[[general-rules]]
== RoboCupJunior International {rules-year} General Rules
