...
[[pulsed-golf-2026]]
=== Golf-ball sized pulsed ball since 2026
Since 2026, Soccer Infrared has been using a new IR Ball. The key
difference with this ball is the size change from 74mm to 42mm diameter,
which is the same size as the Soccer Vision League's passive ball. This ball is
