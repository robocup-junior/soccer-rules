...
away from the short edge of the field. They align with the sides of the penalty
...
You can preview the STEP file with https://3dviewer.net/#model=https://raw.githubusercontent.com/robocup-junior/soccer-rules/refs/heads/master/media/CAD/SoccerField_202605.step[Online 3D Viewer]
...
=== Building the field
After considering all of the above compromises and gathering all of the needed items from the link:https://docs.google.com/spreadsheets/d/17-ZvGeDSZbHwIeh-iJHFqOkcqPsvwN1VsUMdfY3ixr4/edit?usp=sharing[Bill of Material], you can start building the field.
