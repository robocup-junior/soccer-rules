...
{++The task in this technical challenge is to score into an open goal from the
other half of the field. In order to pass the challenge, the ball can only
touch the other half of the field inside the penalty area and the goal itself.
