...
teams abide by <<league-regulations, League regulations>>, 
especially <<regulations-construction, Construction>>
and <<regulations-programming, Programming>>, and all other competitor’s rules.
...
|size / diameter | Ø 22.0 cm ^[4]^| Ø 22.0 cm +
...
- {++The Intro League should ignore the Out of Bounds (<<out-of-bounds>>) rule.
