...
Please see here
footnote:[
https://robocup-junior.github.io/soccer-rules/2025-soccer-draft-rules/ball_specification.pdf
or https://robocup-junior.github.io/soccer-rules/2025-soccer-draft-rules/ball_specification.html]
for ball specifications and <<league-regulations>> for
more details for league specifics.
...
gameplay. A referee may permit robot
...
See <<international-competition-gameplay>>++}
...
[[specification-for-soccer-field]]
=== Specification for Soccer Field

See here
footnote:[
https://robocup-junior.github.io/soccer-rules/2025-soccer-draft-rules/field_specification.pdf
or https://robocup-junior.github.io/soccer-rules/2025-soccer-draft-rules/field_specification.html]

[[ball]]
== BALL

For detailled ball specifications see here
footnote:[
https://robocup-junior.github.io/soccer-rules/2025-soccer-draft-rules/ball_specification.pdf
or https://robocup-junior.github.io/soccer-rules/2025-soccer-draft-rules/ball_specification.html]
...
footnote:[ for detailled ball specifications see:
https://robocup-junior.github.io/soccer-rules/2025-soccer-draft-rules/ball_specification.pdf
or https://robocup-junior.github.io/soccer-rules/2025-soccer-draft-rules/ball_specification.html]
...
IMPORTANT: [2] We *strongly* encourage teams to include protection circuits for Lithium-based
batteries
...
IMPORTANT: Robots must be constructed and programmed exclusively by the student members of a
...
found in the scoring document available at:
https://robocup-junior.github.io/soccer-rules-entry/master/scoring.pdf
https://robocup-junior.github.io/soccer-rules-entry/master/scoring.html
...
organizers if and what kind of interview to expect.
...
Details on the size and construction of the field can be found in the
field specification document. footnote:[
https://robocup-junior.github.io/soccer-rules-entry/master/field_specification.html and
https://robocup-junior.github.io/soccer-rules-entry/master/field_specification.pdf]
