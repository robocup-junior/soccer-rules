...
.Think of the convex hull requirement as a rubber band that must fit around all points of the robot, i.e. the ball may not go inside the convex hull (red line) more than allowed
image::media/Convex_Hull_Robot.png[scaledwidth=80%]
