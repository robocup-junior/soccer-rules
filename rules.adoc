...
are late for the start of the game may be penalized one goal *_per 30 seconds_*
at the referee’s discretion.~>Teams are considered late for the start of the game if they don't show up with at least one working robot. 
They may be penalized one goal *_per 30 seconds_* at the referee’s discretion.
When the penalty has reached 10 -- 0, they automatically will lose the game.~~}
