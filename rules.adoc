= RoboCupJunior Soccer Rules 2020
{docdate}
:toc: left
:sectanchors:
:sectlinks:
...
<<out-of-bounds>> or are either damaged <<damaged-robots>>), the penalties are
...
<<field-diagrams>>). {++It is recommended that the blue be of a brighter shade
...
In front of each goal there is a 30 cm wide and {~~90 cm~>70 cm~~} long penalty area.

The penalty areas are marked by a {~~black~>white~~} line of 20 mm width. The line is part of the area.
...
|size / diameter | {~~Ø 22.0 cm~>Ø 20.0 cm~~} ^[4]^| Ø 22.0 cm +
|height | {~~22.0 cm~>20.0 cm~~} ^[1]^ ^[4]^ | 22.0 cm ^[1]^ +
|weight | {~~2400 g~>2300 g~~} ^[2]^ ^[4]^ | 1100 g ^[2]^ +
...
in the Open sub-league to be 20 cm for 2020 and 2021 seasons, with further
decrease to 18cm from the 2022 season onwards. Similarly, the weight of 2300 g
is intended to be used in 2020 and 2021 seasons, with further decrease to 2200g
in 2022.++}
...
remote control receivers (TSOP1140, TSOP31140, GP1UX511QS, ...
