...
{++The ball needs to stay within the bounds of the playing field, as delimited
by the walls. If a robot moves the ball outside of the playing field (that,
beyond the walls or above their height), it is deemed damaged.
(<<damaged-robots>>)++}
...
areas are marked with a white line, they are deemed to be out of the reach of
any of the robots and the Out of Bounds rule applies as well. (<<out-of-bounds>>)
