...
TIP: The Soccer league is planning to increase the team size to 5. For
logistical reasons only 4 members per team can be guaranteed for the Incheon
competition as of 2026-01-21. We recommend team size 5 for SuperRegionals and
